...
public class UserController {
    ...
    public Map<String, Boolean> addMyFollowers(@PathVariable(value = "id") Long userId,
                                             @PathVariable(value = "followerId") Long followerId) throws Exception {
        // TODO follower implementation
        Map<String, Boolean> response = new HashMap<>();
        return response;
    }
